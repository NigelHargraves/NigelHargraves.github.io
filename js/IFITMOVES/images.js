...
let drone = new Image();
drone.src = 'images/IFITMOVES/drone.png';
let droneShadow = new Image();
droneShadow.src = 'images/IFITMOVES/droneShadow.png';
...
let keyShadow = new Image();
keyShadow.src = 'images/IFITMOVES/keyShadow.png';
...
let turquoiseTrapBaseImage = new Image();
turquoiseTrapBaseImage.src = 'images/IFITMOVES/turquoiseTrapBaseImage.png';
let trapImage = new Image();
trapImage.src = 'images/IFITMOVES/trapImage.png';
let shadowTrapKey1 = new Image();
shadowTrapKey1.src = 'images/IFITMOVES/shadowTrapKey1.png';
let shadowTrapKey2 = new Image();
shadowTrapKey2.src = 'images/IFITMOVES/shadowTrapKey2.png';
let shadowTrapKey3 = new Image();
shadowTrapKey3.src = 'images/IFITMOVES/shadowTrapKey3.png';
let shadowTrapKey4 = new Image();
shadowTrapKey4.src = 'images/IFITMOVES/shadowTrapKey4.png';
...
let turquoiseTrapKey1 = new Image();
turquoiseTrapKey1.src = 'images/IFITMOVES/turquoiseTrapKey1.png';
let turquoiseTrapKey2 = new Image();
turquoiseTrapKey2.src = 'images/IFITMOVES/turquoiseTrapKey2.png';
let turquoiseTrapKey3 = new Image();
turquoiseTrapKey3.src = 'images/IFITMOVES/turquoiseTrapKey3.png';
let turquoiseTrapKey4 = new Image();
turquoiseTrapKey4.src = 'images/IFITMOVES/turquoiseTrapKey4.png';
let turquoiseTrapKeyHole1Filled = new Image();
turquoiseTrapKeyHole1Filled.src = 'images/IFITMOVES/turquoiseTrapKeyHole1Filled.png';
let turquoiseTrapKeyHole1Empty = new Image();
turquoiseTrapKeyHole1Empty.src = 'images/IFITMOVES/turquoiseTrapKeyHole1Empty.png';
let turquoiseTrapKeyHole2Filled = new Image();
turquoiseTrapKeyHole2Filled.src = 'images/IFITMOVES/turquoiseTrapKeyHole2Filled.png';
let turquoiseTrapKeyHole2Empty = new Image();
turquoiseTrapKeyHole2Empty.src = 'images/IFITMOVES/turquoiseTrapKeyHole2Empty.png';
let turquoiseTrapKeyHole3Filled = new Image();
turquoiseTrapKeyHole3Filled.src = 'images/IFITMOVES/turquoiseTrapKeyHole3Filled.png';
let turquoiseTrapKeyHole3Empty = new Image();
turquoiseTrapKeyHole3Empty.src = 'images/IFITMOVES/turquoiseTrapKeyHole3Empty.png';
let turquoiseTrapKeyHole4Filled = new Image();
turquoiseTrapKeyHole4Filled.src = 'images/IFITMOVES/turquoiseTrapKeyHole4Filled.png';
let turquoiseTrapKeyHole4Empty = new Image();
turquoiseTrapKeyHole4Empty.src = 'images/IFITMOVES/turquoiseTrapKeyHole4Empty.png';
...
let turquoiseTrapKey1Backpack = document.createElement("IMG");
turquoiseTrapKey1Backpack.setAttribute("src", "images/IFITMOVES/turquoiseTrapKey1.png");
turquoiseTrapKey1Backpack.setAttribute("width", "40");
turquoiseTrapKey1Backpack.setAttribute("height", "40");

let turquoiseTrapKey2Backpack = document.createElement("IMG");
turquoiseTrapKey2Backpack.setAttribute("src", "images/IFITMOVES/turquoiseTrapKey2.png");
turquoiseTrapKey2Backpack.setAttribute("width", "40");
turquoiseTrapKey2Backpack.setAttribute("height", "40");

let turquoiseTrapKey3Backpack = document.createElement("IMG");
turquoiseTrapKey3Backpack.setAttribute("src", "images/IFITMOVES/turquoiseTrapKey3.png");
turquoiseTrapKey3Backpack.setAttribute("width", "40");
turquoiseTrapKey3Backpack.setAttribute("height", "40");

let turquoiseTrapKey4Backpack = document.createElement("IMG");
turquoiseTrapKey4Backpack.setAttribute("src", "images/IFITMOVES/turquoiseTrapKey4.png");
turquoiseTrapKey4Backpack.setAttribute("width", "40");
turquoiseTrapKey4Backpack.setAttribute("height", "40");