...
function init() {
  ...
  moveLeft = false, moveRight = false, moveUp = false, moveDown = false, eyesBlink = false, eyesSquint = false, increaseBounce = false, fadeText = false, missile = false, playerAlive = true, minesToPlant = false, endGameSound = false, playerSheild = false, LBall = false, collectedFlowerSacks = false, collectedMilkBottles = false, collectedSugars = false, collectedEggs = false, cooking = false, cakeReady = false;
  width = 0;
  elem.style.width = width + "%";
