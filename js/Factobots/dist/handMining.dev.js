...
function handMine() {
  //mine burnium.
  var readyToMine = collisionDetection(ground.x * -1 + mouse.x, ground.y * -1 + mouse.y, 10, 10, burn.x, burn.y, burn.resourceSize / 2, burn.resourceSize / 2);
  ...
  readyToMine = collisionDetection(ground.x * -1 + mouse.x, ground.y * -1 + mouse.y, 10, 10, hardOre.x, hardOre.y, hardOre.resourceSize / 2, hardOre.resourceSize / 2);
